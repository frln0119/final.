...
class signup extends JFrame {
    ...
    usernameIcon.setIcon(new ImageIcon(
                new ImageIcon("images/user-icon.jpg").getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT)));
    usernameIcon.setBounds(130, 120, 190, 40);
    add(usernameIcon);
    hero = new JLabel("");
    hero.setIcon(new ImageIcon(
                new ImageIcon("images/pass-confirm.jpeg").getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT)));
    hero.setBounds(130, 180, 190, 40);
    add(hero);
    pass = new JLabel("");
    pass.setIcon(new ImageIcon(
                new ImageIcon("images/pass-icon.jpg").getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT)));
...
JButton cancel, submit;
	...
	void appointmentInterface() {
        ...
        hours = new JLabel("");
        hours.setIcon(new ImageIcon(
                new ImageIcon("images/hours.jpeg").getImage().getScaledInstance(60, 60, Image.SCALE_DEFAULT)));
        hours.setBounds(50, 90, 160, 40);
        add(hours);

        min = new JLabel("");
        min.setIcon(new ImageIcon(
                new ImageIcon("images/minutes.jpeg").getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT)));
        min.setBounds(50, 160, 160, 40);
        add(min);

        pmam = new JLabel("");
        pmam.setIcon(new ImageIcon(
                new ImageIcon("images/ampm.jpeg").getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT)));
        pmam.setBounds(50, 230, 160, 40);
        add(pmam);

        dateicon = new JLabel("");
        dateicon.setIcon(new ImageIcon(
                new ImageIcon("images/date.jpg").getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT)));
